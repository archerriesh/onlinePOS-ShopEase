...
<head>
    ...
    <link rel="stylesheet" href="/onlinePOS/css/style.css">
</head>
<body>
    ...
    <div class="collapse navbar-collapse" id="authNavbar">
        <div class="ms-auto">
            <?php if ($authPage === 'signin'): ?>
                <a href="/onlinePOS/pages/sign-up-page.php" class="signbtn">
                    Sign Up
                </a>
            <?php else: ?>
                <a href="/onlinePOS/pages/sign-in-page.php" class="signbtn">
                    Sign In
                </a>
            <?php endif; ?>
        </div>
