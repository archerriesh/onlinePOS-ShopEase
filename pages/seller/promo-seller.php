...
<div class="promo-page">
    <div class="button-container">
        <button class="btn btn-primary" onclick="window.location.href='promo-seller.php'">ShopEase voucher</button>
        <button class="btn btn-secondary" onclick="window.location.href='my-voucher.php'">My voucher</button>
        ...
        <div class="voucher-wrapper" id="voucherWrapper">
            <div class="voucher-grid">
                ...
                $query = "SELECT * FROM tbpromo 
                          WHERE (idPenjual IS NULL OR TRIM(idPenjual) = '' OR idPenjual = '-') 
                ...
                ?>
                <div class="voucher-card" onclick="window.location.href='kelola-voucher.php?id=<?php echo $row['idPromo']; ?>'">
                ...
                <?php 
                    ...
                    echo "<p style='grid-column: 1/-1; text-align: center;'>No ShopEase (Admin) vouchers found.</p>";
                }
                ?>
            </div> 
        </div> 
